  ...
  return (
    <div className="noc-ctx-menu" style={{ left: ctxMenu.x, top: ctxMenu.y }}>
      {!ctxMenu.targetIsNode && (
        <button style={{ color: '#d1d5db' }} className="noc-ctx-remove" onClick={onDetails}>
      ...
      {editMode && !(ctxMenu.targetIsNode && ctxMenu.targetId.includes('anchor')) && (
        <button style={{ color: '#d1d5db' }} className="noc-ctx-remove" onClick={onEdit}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14">
      ...
      {editMode && !ctxMenu.targetIsNode && (
        <button style={{ color: '#d1d5db' }} className="noc-ctx-remove" onClick={onAddAnchor}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14">
            <circle cx="12" cy="12" r="10"></circle>
